...
namespace Mewdeko.Services.Settings
{
    ...
    public sealed class BotConfigService : ConfigServiceBase<BotConfig>
    {
            ...
            : base(FilePath, serializer, pubSub, ChangeKey)
        {
            ...
            AddParsedProp("chatgptchannel2", bs => bs.ChatGptChannel2, ulong.TryParse, ConfigPrinters.ToString);
            ...
            AddParsedProp("QuarantineNotification", bs => bs.QuarantineNotification, bool.TryParse, ConfigPrinters.ToString);
