...
public class BotCredentials : IBotCredentials
{
    ...
    private void UpdateCredentials(object sender, FileSystemEventArgs e)
    {
        ...
        {
            Log.Error("An error occurred while loading the credentials. Please fix your credentials file and restart the bot.");
    ...
    private class CredentialsModel : IBotCredentials
    {
        ...
        [JsonIgnore]
        ImmutableArray<ulong> IBotCredentials.OwnerIds => OwnerIds.ToImmutableArray();
