...
public partial class Permissions
{
    ...
    public class BlacklistCommands(IBotCredentials creds) : MewdekoSubmodule<BlacklistService>
    {
        ...
        {
            return Blacklist(action, id, BlacklistType.User, reason);
        }
        ...
        {
            return Blacklist(action, usr.Id, BlacklistType.User, reason);
        }
        ...
        {
            return Blacklist(action, id, BlacklistType.Channel, reason);
        }
        ...
        {
            return Blacklist(action, id, BlacklistType.Server, reason);
        }
        ...
        {
            return Blacklist(action, guild.Id, BlacklistType.Server, reason);
        }
