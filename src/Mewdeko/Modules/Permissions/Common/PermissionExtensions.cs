...
///     These methods extend the functionality of Permission1 objects and collections thereof,
...
public static class PermissionExtensions
{
        ...
        string moduleName)
    {
        ...
        switch ((PrimaryPermissionType)perm.PrimaryTarget)
        {
    ...
    public static string GetCommand(this Permission1? perm, string? prefix, SocketGuild? guild = null)
    {
        var com = "";
        switch ((PrimaryPermissionType)perm.PrimaryTarget)
        {
        ...
        switch ((SecondaryPermissionType)perm.SecondaryTarget)
        {
