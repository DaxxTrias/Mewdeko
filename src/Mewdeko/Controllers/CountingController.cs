...
public class CountingController : Controller
{
    ...
    public async Task<IActionResult> SetupCountingChannel(ulong guildId, ulong channelId, [FromBody] SetupCountingChannelRequest request)
    {
        try
        {
            IGuild guild = client.GetGuild(guildId);
            ...
            var result = await countingService.SetupCountingChannelAsync(guildId, channelId, request.StartNumber, request.Increment);
    ...
    public async Task<IActionResult> GetChannelStatus(ulong guildId, ulong channelId)
    {
        ...
        {
            logger.LogError(ex, "Error getting status for counting channel {ChannelId} in guild {GuildId}", channelId, guildId);
            return StatusCode(500, "Internal server error");
        }
    }
    ...
    public async Task<IActionResult> DisableCountingChannel(ulong guildId, ulong channelId, [FromQuery] ulong userId, [FromQuery] string? reason = null)
    {
        try
        {
            var countingChannel = await countingService.GetCountingChannelAsync(channelId);
    ...
    public async Task<IActionResult> GetChannelConfig(ulong guildId, ulong channelId)
    {
        ...
        {
            logger.LogError(ex, "Error getting config for counting channel {ChannelId} in guild {GuildId}", channelId, guildId);
            return StatusCode(500, "Internal server error");
        }
    }
    ...
    public async Task<IActionResult> UpdateChannelConfig(ulong guildId, ulong channelId, [FromBody] UpdateCountingConfigRequest request)
    {
        try
        {
            var countingChannel = await countingService.GetCountingChannelAsync(channelId);
        ...
        {
            logger.LogError(ex, "Error updating config for counting channel {ChannelId} in guild {GuildId}", channelId, guildId);
            return StatusCode(500, "Internal server error");
        }
    }
    ...
    public async Task<IActionResult> GetChannelStats(ulong guildId, ulong channelId)
    {
        ...
        {
            logger.LogError(ex, "Error getting stats for counting channel {ChannelId} in guild {GuildId}", channelId, guildId);
            return StatusCode(500, "Internal server error");
        }
    }
        ...
        [FromQuery] int limit = 20)
    {
        try
        {
            ...
            if (!Enum.TryParse<LeaderboardType>(type, true, out var leaderboardType))
                return BadRequest($"Invalid leaderboard type. Valid types: {string.Join(", ", Enum.GetNames<LeaderboardType>())}");
        ...
        {
            logger.LogError(ex, "Error getting leaderboard for counting channel {ChannelId} in guild {GuildId}", channelId, guildId);
            return StatusCode(500, "Internal server error");
        }
    }
    ...
    public async Task<IActionResult> GetUserStats(ulong guildId, ulong channelId, ulong userId)
    {
        ...
        {
            logger.LogError(ex, "Error getting user stats for user {UserId} in counting channel {ChannelId} in guild {GuildId}", userId, channelId, guildId);
            return StatusCode(500, "Internal server error");
        }
    }
    ...
    public async Task<IActionResult> ResetCountingChannel(ulong guildId, ulong channelId, [FromBody] ResetCountingChannelRequest request)
    {
        try
        {
            var countingChannel = await countingService.GetCountingChannelAsync(channelId);
            ...
            var success = await countingService.ResetCountingChannelAsync(channelId, request.NewNumber, request.UserId, request.Reason);
    ...
    public async Task<IActionResult> CreateSavePoint(ulong guildId, ulong channelId, [FromBody] CreateSavePointRequest request)
    {
        try
        {
            var countingChannel = await countingService.GetCountingChannelAsync(channelId);
        ...
        {
            logger.LogError(ex, "Error creating save point for counting channel {ChannelId} in guild {GuildId}", channelId, guildId);
            return StatusCode(500, "Internal server error");
        }
    }
    ...
    public async Task<IActionResult> RestoreFromSave(ulong guildId, ulong channelId, [FromBody] RestoreSavePointRequest request)
    {
        try
        {
            var countingChannel = await countingService.GetCountingChannelAsync(channelId);
        ...
        {
            logger.LogError(ex, "Error restoring counting channel {ChannelId} from save {SaveId} in guild {GuildId}", channelId, request.SaveId, guildId);
            return StatusCode(500, "Internal server error");
        }
    }
