...
namespace DataModel
{
	...
	public class AuthCode
	{
		...
		[Column("Scopes"                                                                                        )] public string?   Scopes       { get; set; } // text
		[Column("Token"                                                                                         )] public string?   Token        { get; set; } // text
		[Column("RefreshToken"                                                                                  )] public string?   RefreshToken { get; set; } // text
