...
namespace DataModel
{
	...
	public class AiConversation
	{
		...
		#region Associations
		/// <summary>
		/// FK_AiMessages_AiConversations_ConversationId backreference
		/// </summary>
		[Association(ThisKey = nameof(Id), OtherKey = nameof(AiMessage.ConversationId))]
		public IEnumerable<AiMessage> AiMessages { get; set; } = null!;
		#endregion
	}
}
