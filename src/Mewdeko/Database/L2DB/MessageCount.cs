...
namespace DataModel
{
	...
	public class MessageCount
	{
		...
		[Column("Count"                                                                                      )] public ulong   Count     { get; set; } // numeric(20,0)
		[Column("DateAdded"                                                                                  )] public DateTime? DateAdded { get; set; } // timestamp (6) without time zone

		#region Associations
		/// <summary>
		/// FK_MessageTimestamps_MessageCounts_MessageCountId backreference
		/// </summary>
		[Association(ThisKey = nameof(Id), OtherKey = nameof(MessageTimestamp.MessageCountId))]
		public IEnumerable<MessageTimestamp> MessageTimestamps { get; set; } = null!;
		#endregion
	}
}
