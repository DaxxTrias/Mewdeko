...
namespace DataModel
{
	...
	public class Warning
	{
		...
		[Column("Forgiven"                                                                                    )] public bool      Forgiven   { get; set; } // boolean
		[Column("ForgivenBy"                                                                                  )] public string?   ForgivenBy { get; set; } // text
		[Column("Moderator"                                                                                   )] public string?   Moderator  { get; set; } // text
