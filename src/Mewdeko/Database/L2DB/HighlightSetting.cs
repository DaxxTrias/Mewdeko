...
namespace DataModel
{
	...
	public class HighlightSetting
	{
		...
		[Column("IgnoredChannels"                                                                                  )] public string?   IgnoredChannels { get; set; } // text
		[Column("IgnoredUsers"                                                                                     )] public string?   IgnoredUsers    { get; set; } // text
		[Column("HighlightsOn"                                                                                     )] public bool      HighlightsOn    { get; set; } // boolean
