...
public class MewdekoDb : DataConnection
{
    ...
    /// <summary>
    ///     Gets the deleted message log ignored users table.
    /// </summary>
    public ITable<DeletedMessageLogIgnoredUser> DeletedMessageLogIgnoredUsers =>
        this.GetTable<DeletedMessageLogIgnoredUser>();
