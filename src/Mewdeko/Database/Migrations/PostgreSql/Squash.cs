    ...
    public partial class Squash : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                UPDATE ""VcRoleInfo"" SET ""GuildId"" = (
                    SELECT ""GuildId"" FROM ""GuildConfigs"" WHERE ""Id"" = ""VcRoleInfo"".""GuildConfigId""
                );
            ");
            ...
            // Other tables
            migrationBuilder.Sql(@"
                UPDATE ""GuildRepeater"" SET ""GuildId"" = (
                    SELECT ""GuildId"" FROM ""GuildConfigs"" WHERE ""Id"" = ""GuildRepeater"".""GuildConfigId""
                );
                ...
                UPDATE ""FollowedStream"" SET ""GuildId"" = (
                    SELECT ""GuildId"" FROM ""GuildConfigs"" WHERE ""Id"" = ""FollowedStream"".""GuildConfigId""
                );
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarningPunishment_GuildId_Count",
                table: "WarningPunishment",
