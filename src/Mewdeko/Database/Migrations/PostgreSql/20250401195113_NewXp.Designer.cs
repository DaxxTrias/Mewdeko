...
namespace Mewdeko.Database.Migrations.PostgreSql
{
    ...
    [Migration("20250401195113_NewXp")]
    partial class NewXp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.ChatLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.CustomVoiceChannel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("AllowedUsersJson")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("DeniedUsersJson")
                        .HasColumnType("text");
                    ...
                    b.ToTable("CustomVoiceChannel");
                });

            modelBuilder.Entity("Mewdeko.Database.Models.CustomVoiceConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("AllowBitrateCustomization")
                        .HasColumnType("boolean");

                    b.Property<bool>("AllowLocking")
                        .HasColumnType("boolean");

                    b.Property<bool>("AllowMultipleChannels")
                        .HasColumnType("boolean");

                    b.Property<bool>("AllowNameCustomization")
                        .HasColumnType("boolean");

                    b.Property<bool>("AllowUserLimitCustomization")
                        .HasColumnType("boolean");

                    b.Property<bool>("AllowUserManagement")
                        .HasColumnType("boolean");

                    b.Property<bool>("AutoPermission")
                        .HasColumnType("boolean");

                    b.Property<decimal?>("ChannelCategoryId")
                        .HasColumnType("numeric(20,0)");

                    b.Property<decimal?>("CustomVoiceAdminRoleId")
                        .HasColumnType("numeric(20,0)");

                    b.Property<DateTime?>("DateAdded")
                        .HasColumnType("timestamp without time zone");

                    b.Property<int>("DefaultBitrate")
                        .HasColumnType("integer");

                    b.Property<string>("DefaultNameFormat")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("DeleteWhenEmpty")
                        .HasColumnType("boolean");

                    b.Property<int>("EmptyChannelTimeout")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("PersistUserPreferences")
                        .HasColumnType("boolean");

                    b.HasKey("Id");

                    b.ToTable("CustomVoiceConfig");
                });
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.DiscordUser", b =>
                {
                    ...
                    b.Property<bool>("GreetDmsOptOut")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.Embeds", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.InviteCount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.LockdownChannelPermissions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("LockdownChannelPermissions");
                });

            modelBuilder.Entity("Mewdeko.Database.Models.LoggingV2", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.MessageTimestamp", b =>
                {
                    ...
                    b.Property<long>("MessageCountId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("MessageCountId");

                    b.ToTable("MessageTimestamps");
                });
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.Polls", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.StarboardConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("CheckedChannels")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("RemoveOnBelowThreshold")
                        .HasColumnType("boolean");

                    b.Property<bool>("RemoveOnDelete")
                        .HasColumnType("boolean");

                    b.Property<bool>("RemoveOnReactionsClear")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.StarboardPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("StarboardConfigId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.ToTable("StarboardPosts");
                });
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.UserVoicePreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.VcRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.AiMessage", b =>
                {
                    b.HasOne("Mewdeko.Database.Models.AiConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.CommandAlias", b =>
                {
                    b.HasOne("Mewdeko.Database.Models.GuildConfigs.GuildConfig", null)
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.MessageTimestamp", b =>
                {
                    b.HasOne("Mewdeko.Database.Models.MessageCount", "MessageCount")
                        .WithMany("Timestamps")
                        .HasForeignKey("MessageCountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MessageCount");
                });
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.Protections.AntiAltSetting", b =>
                {
                    b.HasOne("Mewdeko.Database.Models.GuildConfigs.GuildConfig", null)
                        ...
                        .HasForeignKey("Mewdeko.Database.Models.Protections.AntiAltSetting", "GuildConfigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.Protections.AntiMassMentionSetting", b =>
                {
                    b.HasOne("Mewdeko.Database.Models.GuildConfigs.GuildConfig", null)
                        ...
                        .HasForeignKey("Mewdeko.Database.Models.Protections.AntiMassMentionSetting", "GuildConfigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.Protections.AntiRaidSetting", b =>
                {
                    b.HasOne("Mewdeko.Database.Models.GuildConfigs.GuildConfig", null)
                        ...
                        .HasForeignKey("Mewdeko.Database.Models.Protections.AntiRaidSetting", "GuildConfigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.Protections.AntiSpamSetting", b =>
                {
                    b.HasOne("Mewdeko.Database.Models.GuildConfigs.GuildConfig", null)
                        ...
                        .HasForeignKey("Mewdeko.Database.Models.Protections.AntiSpamSetting", "GuildConfigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Mewdeko.Database.Models.TicketNote", b =>
                {
                    b.HasOne("Mewdeko.Database.Models.Ticket", "Ticket")
                        .WithMany("Notes")
