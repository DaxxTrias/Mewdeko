...
ALTER TABLE "PanelButtons"
    ALTER COLUMN "SupportRoles" TYPE bigint[],
    ALTER COLUMN "ViewerRoles" TYPE bigint[];
...
ALTER TABLE "PanelButtons"
    ...
    ALTER COLUMN "ArchiveCategoryId" TYPE bigint;
...
ALTER TABLE "Tickets"
    ...
    ALTER COLUMN "ClaimedBy" TYPE bigint;
...
ALTER TABLE "NoteEdits"
    ALTER COLUMN "EditorId" TYPE bigint;
