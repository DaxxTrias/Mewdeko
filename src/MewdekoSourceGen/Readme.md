...
### MewdekoSourceGen.Sample

A project that references source generators. Note the parameters of `ProjectReference`
in [MewdekoSourceGen.Sample.csproj](../MewdekoSourceGen.Sample/MewdekoSourceGen.Sample.csproj), they make sure that the
project is referenced as a set of source generators.

### MewdekoSourceGen.Tests
